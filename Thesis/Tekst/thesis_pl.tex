...
\item Mierzenie kątów na podstawie 3 wybranych przez użytkownika punktów.
\end{itemize}

Przykładowym projektem korzystającym z bibliotek Cornerstone jest OHIF\footnote {Open Health Imaging Foundation - http://ohif.org/ } Viewer. Aplikacja pozwala na wykorzystanie większości możliwości udostępnianych przez biblioteki Cornerstone. Przykładowe użycie aplikacji zostało przedstawione na rysunku \ref{fig:OHIF-example}.
