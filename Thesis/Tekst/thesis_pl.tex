...
obrazowania, czy też ze~względu na~różnorodność tekstury tkanki obrazowanej (innej dla kążdego pacjenta).

\subsection {Przeglądarki DICOM}

Istnieje wiele rozwiązań umożliwiających wykonywanie obrysów przy użyciu przeglądarki.
W~tej pracy opisano szczegółowo dwie wybrane aplikacje, które według nas w~największym
...
ani półautomatyczniy.

\section {Proponowane rozwiązanie}

Przygotowane rozwiązanie zapewnia funkcjonalności niedostępne w innych narzędziach
takie jak połączenie funkcjonalności manualnego i półautomatycznego generowania obryów,
zapisanie i przeglądanie wykonanych i wygenerowanych obrysów,
obliczanie statystyk związanych z wykonanymi obrysem jak również zmiania danych pacjenta
...
\begin{enumerate}[label=(\alph*)]
  \item użyteczność pod względem dostępności z różnych urządzeń o rozdzielczościach
   1920 na 1080 pikseli oraz pod względem zapewnienia dostępu do zapisanych na serwerze obrysów
