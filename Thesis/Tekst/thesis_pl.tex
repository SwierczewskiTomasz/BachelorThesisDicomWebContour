...
został użyty operator Canny'ego, a~następnie punkty przetwarzanie są
...
pole obrysu, środek ciężkości obrysu, histogram regionu zainteresowania (ang. \textit{ROI ---
region of interest}) zawartego w obrysie oraz
...
zarówno w~przetwarzaniu obrazów medycznych, jaki i~innych bardziej ogólnych zastosowaniach
...
Potwierdza to~porównanie operatorów wykrywania krawędzi zobrazowane
w~\cite{Cyfrowe przetwarzanie obrazów medycznych}, operator Canny'ego
...
\bibitem{GK1} Kotowski P.: Wykłady z~przedmiotu Grafika Komputerowa~1~\emph{Politechnika Warszawska, Wydział Matematyki i~Nauk Informacyjnych} Materiały dostepne na~stronie: http://mini.pw.edu.pl/~kotowski/gk/gk.html [Dostęp 01~kwietnia 2019]
